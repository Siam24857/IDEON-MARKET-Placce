...
export type ProfileOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "headline" | "occupation" | "education" | "experience" | "phoneNumber" | "country" | "city" | "dateOfBirth" | "updatedAt", ExtArgs["result"]["profile"]>;
