...
export type GetSearchHistoryAggregateType<T extends SearchHistoryAggregateArgs> = {
    [P in keyof T & keyof AggregateSearchHistory]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateSearchHistory[P]> : Prisma.GetScalarType<T[P], AggregateSearchHistory[P]>;
};
...
export type GetSearchHistoryGroupByPayload<T extends SearchHistoryGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<SearchHistoryGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof SearchHistoryGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], SearchHistoryGroupByOutputType[P]> : Prisma.GetScalarType<T[P], SearchHistoryGroupByOutputType[P]>;
}>>;
export type SearchHistoryWhereInput = {
    ...
    filters?: Prisma.JsonNullableFilter<"SearchHistory">;
...
export type SearchHistoryScalarWhereWithAggregatesInput = {
    ...
    filters?: Prisma.JsonNullableWithAggregatesFilter<"SearchHistory">;
...
export type SearchHistoryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "query" | "filters" | "createdAt", ExtArgs["result"]["searchHistory"]>;
...
export type SearchHistoryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<SearchHistoryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SearchHistoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['SearchHistory'];
        meta: {
            name: 'SearchHistory';
        };
    };
     ...
     * })
    **/
    count<T extends SearchHistoryCountArgs>(args?: Prisma.Subset<T, SearchHistoryCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], SearchHistoryCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends SearchHistoryGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, SearchHistoryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSearchHistoryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface SearchHistoryFieldRefs {
    ...
    readonly filters: Prisma.FieldRef<"SearchHistory", 'Json'>;
